    ...
    return (
        <form className='grid grid-cols-3 gap-x-[50px] mx-8'>
            <div>
                ...
                <select id="type" className="bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                ...
                <select id="size" className="bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
